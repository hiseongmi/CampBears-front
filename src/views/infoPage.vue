...
export default {
  ...
  setup() {
    ...
    const bu = () => {
      ...
      // 첫화면에 미리 캠핑장이 검색되게
      function first() {
        document.getElementById("keyword").value = "부산캠핑장";
        searchPlaces();
      }
    ...
    const dgu = () => {
      ...
      // 첫화면에 미리 캠핑장이 검색되게
      function first() {
        document.getElementById("keyword").value = "대구캠핑장";
        searchPlaces();
      }
    ...
    const dj = () => {
      ...
      // 첫화면에 미리 캠핑장이 검색되게
      function first() {
        document.getElementById("keyword").value = "대전캠핑장";
        searchPlaces();
      }
    ...
    const su = () => {
      ...
      // 첫화면에 미리 캠핑장이 검색되게
      function first() {
        document.getElementById("keyword").value = "서울캠핑장";
        searchPlaces();
      }
...
<template>
  ...
  <div class="info-main">
    ...
    <div class="info-box">
      <div class="info-shapbox">
        <a class="info-shap" @click="mok"> #목포 </a>
        <a class="info-shap" @click="su"> #서울 </a>
        <a class="info-shap" @click="dj"> #대전 </a>
        <a class="info-shap" @click="dgu"> #대구 </a>
        <a class="info-shap" @click="bu"> #부산 </a>
      </div>
      <!--      <div class="info-shapbox" v-for="item in tagList">-->
      <!--        <a class="info-shap" :href="item.link" @click="mok">-->
      <!--          {{ item.name }}-->
      <!--        </a>-->
      <!--      </div>-->
    </div>
